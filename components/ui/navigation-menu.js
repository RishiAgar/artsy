...
const NavigationMenuContent = forwardRef(({ className, ...props }, ref) => (
    <NavigationMenuPrimitive.Content
        ref={ref}
        className={cn(
            "left-0 top-0 w-full rounded-md border bg-popover text-popover-foreground shadow data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 md:absolute md:left-1/2 md:top-full md:z-20 md:mt-3 md:w-auto md:min-w-[220px] md:-translate-x-1/2 md:rounded-lg md:border md:bg-background md:shadow-lg",
            className
        )}
        {...props} />
))
